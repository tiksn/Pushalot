...
namespace TIKSN.Pushalot
{
    public class Message
    {
        ...
        public Message(string title, string body, MessageLink link, bool isImportant, bool isSilent, MessageImage image, string source, int? timeToLive)
        {
        ...
        public MessageLink Link { get; private set; }

        public bool IsImportant { get; private set; }

        public bool IsSilent { get; private set; }

        public MessageImage Image { get; private set; }
